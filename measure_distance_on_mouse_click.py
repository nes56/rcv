...
def draw_measure_box(x, y):
    ...
    y_diviation_degree = (float(dy)/float(y_pixels_per_degree))
    ...
    # miltiply the distance  with constant (guess work) to adjust the distance
    print("adjusted distance is  * 0.785 = {}".format(d_to_x_y * 0.785))
...
def main():
    ...
    parser.add_argument('--camera-height', type=float, default=43.3,
